...
export class PointCloudMaterial extends RawShaderMaterial {
  ...
  @uniform("groundPlane") groundPlane!: number;
  ...
  static makeOnBeforeRender(
    ...
    return (
      ...
      const vnStart = pointCloudMaterial.visibleNodeTextureOffsets.get(
        node.name
      );
